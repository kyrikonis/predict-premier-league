        ...
        <div className="flex flex-col gap-3">
          {round.fixtures.map((fixture) => {
            ...
            return (
              <div
                key={fixture.id}
                className="flex items-center justify-between rounded-md border border-black/10 p-4 dark:border-white/10"
              >
                <div>
                  ...
                  <p className="text-xs text-black/50 dark:text-white/50">
                    {prediction
                      ? `Your prediction: ${prediction.predictedHome} - ${prediction.predictedAway}`
